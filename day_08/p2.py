...
# Connect boxes with other boxes/circuits that have the smallest distance until they're all connected 
circuits = []
...
print(circuitSizes)
print("Product of the last two connected X coordinates:", int(p1[0]) * int(p2[0]))